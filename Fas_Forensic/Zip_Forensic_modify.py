...
def Forensic(rzip):
    with open(rzip, "rb") as infile:
        ...
        # End of Central Directory 시작 Offset 찾기
        ...
        # End of Central Directory 의 Offset 에 맞게 값을 구해줌
        ...
        # Central Directory 의 Local File Header 값을 list에 저장
        Local_Header_list = []

        # Central Directory 의 개수 만큼 반복
        ...
        # Local File Header 구하기
        # Local File Header의 개수 만큼 반복
